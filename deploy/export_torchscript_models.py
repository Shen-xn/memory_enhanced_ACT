...
def normalize_act_config(payload: Dict) -> Dict:
    ...
    return {
        ...
        "prototype_loss_weight": payload.get("PROTOTYPE_LOSS_WEIGHT", _pick(payload, "prototype_loss_weight", 0.1)),
        ...
        "phase_num_prototypes": payload.get("PHASE_NUM_PROTOTYPES", _pick(payload, "phase_num_prototypes", 16)),
        "phase_pca_dim": payload.get("PHASE_PCA_DIM", _pick(payload, "phase_pca_dim", 0)),
        "phase_pca_var_ratio": payload.get("PHASE_PCA_VAR_RATIO", _pick(payload, "phase_pca_var_ratio", 0.85)),
