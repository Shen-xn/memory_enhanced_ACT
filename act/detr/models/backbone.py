    ...
    def __init__(self, name: str,
        ...
        if depth_channel:
            ...
            with torch.no_grad():
                ...
                new_conv.weight.data[:, 3:] = old_weight.mean(dim=1, keepdim=True)
...
def build_backbone(args):
    ...
    backbone = Backbone(args.backbone, train_backbone, return_interm_layers, args.dilation, args.depth_channel)
